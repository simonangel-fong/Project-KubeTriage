...
AI agents offer a path to automated log analysis and `root cause analysis (RCA)` summarization — but introducing autonomous agents
...
- **Tools**: `ArgoCD`, `n8n`, `Anthropic API`
...
[PoC Demo](./01_n8n/docs/n8n_demo.md) · [n8n Workflow](./01_n8n/docs/n8n_workflow.md)
...
[Kagent Demo](./02_kagent/docs/kagent_demo.md) · [Kagent Installation](./02_kagent/docs/kagent_install.md)
...
- **Architecture Diagram** - Function Calling
  ...
  [Function Calling Demo](./03_agent-function-calling/docs/agent_func_call_demo.md) · [Function Calling Details](./03_agent-function-calling/docs/agent_func_call_readme.md)

- **Architecture Diagram** - Autonomous
  ![pic](./04_agent-autonomous/pic/agent_auto_diagram.png)
  [Autonomous Demo](./04_agent-autonomous/docs/agent_auto_demo.md) · [Autonomous Details](./04_agent-autonomous/docs/agent_auto_readme.md)
